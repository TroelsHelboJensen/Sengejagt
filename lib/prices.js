// Delt pris-hentningslogik. Bruges af api/prices.js (Vercel serverless), som
// "Slå priser op"-knappen på forsiden kalder for at VISE aktuelle priser.
//
// Strategi pr. side:
...
async function resolveBed(bed) {
  ...
  return {
    ...
    source: null,
    ok: false,
    note: 'Ingen pris fundet — indtast prisen manuelt pr. seng',
  }
}
